        ...
        if(book.checkISBNexists(isbn)) {
            ...
            if(imagePath != null) {
                try {
                    ...
                    int totalQuantity = Integer.parseInt(jSpinner_Quantity.getValue().toString());
                    ...
                    BookDTO bookDTO = new BookDTO(name, isbn, genre_id, author_id, publisher, price, date_received, description, totalQuantity, borrowQuantity, picture);
                    if(book.add(bookDTO)) {
